...
namespace SIP_Agent.System
{
    ...
    public static class I18n
    {
        ...
        /// Default language
        /// </summary>
        private static string defaultLang = I18n.ESTONIAN;

        /// <summary>
        /// Current language
        /// </summary>
        private static string lang = I18n.defaultLang;
        ...
        public static string str(string input, Dictionary<string, string> replacements = null)
        {
            ...
            Dictionary<string, string> translations = Est.Table();
